...
import { getNewsById, getNews, type News } from "../api/newsApi";
...
function DetailBerita() {
  ...
  useEffect(() => {
    ...
    const fetchDetailAndLatest = async () => {
      ...
      try {
        setLoading(true);
        setError(false);
        const [detailData, allNewsData] = await Promise.all([
          getNewsById(Number(id)),
          getNews(),
        ]);

        setNews(detailData);
        // Filter out current news and get top 4 latest news
        const filtered = allNewsData
  ...
  const shareTitle = news ? encodeURIComponent(news.title) : "";
      ...
      <div className="mx-auto max-w-[1200px]">
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-24 gap-4">
            ...
            <p className="text-gray-600 font-medium animate-pulse">Memuat berita...</p>
          </div>
        )}
        ...
        {!loading && (error || !news) && (
          <div className="bg-white rounded-3xl p-10 text-center shadow-lg border border-red-100 max-w-[600px] mx-auto">
            ...
            <p className="text-gray-500 mb-6">
              Berita tidak ditemukan atau terjadi kesalahan saat menghubungi server.
            </p>
            <Link
              to="/"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <article className="overflow-hidden rounded-3xl bg-white shadow-md hover:shadow-lg transition-shadow border border-gray-100">
                ...
                <div className="p-6 md:p-10">
                  {/* Category & Reading Time Meta Badges */}
                  ...
                  <div className="text-gray-700 text-base md:text-lg leading-relaxed space-y-6">
                    {news.description ? (
                      ...
                      <p className="italic text-gray-400">Tidak ada konten deskripsi untuk berita ini.</p>
                    )}
                  </div>
            ...
            <div className="lg:col-span-1 flex flex-col gap-6">
              ...
              <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-md">
                ...
                {latestNews.length === 0 ? (
                  <p className="text-sm text-gray-400 italic">Tidak ada berita terbaru lainnya</p>
                ) : (
